<script lang="ts">
  ...
  async function loadConfig() {
    try {
      const config = await invoke('load_llm_config') as LlmConfig;
...
<main class="min-h-screen bg-gradient-to-br from-background to-gray-200 dark:from-background-dark dark:to-gray-900 p-8 flex items-center justify-center transition-colors duration-500">
  <div class="bg-white bg-opacity-80 dark:bg-card-dark dark:bg-opacity-80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 w-full max-w-7xl lg:max-w-full xl:max-w-screen-xl 2xl:max-w-screen-2xl transition-all duration-500">
    <div class="flex justify-between items-center mb-10">
      ...
      <button onclick={toggleDarkMode} class="p-3 rounded-full bg-gray-200 bg-opacity-50 dark:bg-gray-700 dark:bg-opacity-50 text-foreground dark:text-foreground-dark hover:bg-gray-300 hover:bg-opacity-70 dark:hover:bg-gray-600 dark:hover:bg-opacity-70 focus:outline-none focus:ring-4 focus:ring-primary focus:ring-opacity-50 dark:focus:ring-primary-dark dark:focus:ring-opacity-50 transition-all duration-300">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
      ...
      <div class="space-y-8">
        <!-- Step 1: Source Files -->
        <div class="p-6 bg-card bg-opacity-50 dark:bg-card-dark dark:bg-opacity-50 rounded-xl shadow-md transition-all duration-300">
          <h2 class="flex items-center text-2xl font-semibold text-foreground dark:text-foreground-dark mb-4">
            <span class="flex items-center justify-center w-8 h-8 mr-4 bg-primary bg-opacity-20 text-primary dark:bg-primary-dark dark:bg-opacity-20 dark:text-primary-dark rounded-full text-lg">1</span>
            Select Source Files
          </h2>
          <button onclick={selectFiles} class="w-full flex items-center justify-center bg-primary bg-opacity-10 hover:bg-primary hover:bg-opacity-20 dark:bg-primary-dark dark:bg-opacity-10 dark:hover:bg-primary-dark dark:hover:bg-opacity-20 text-primary dark:text-primary-dark font-bold py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 dark:focus:ring-primary-dark dark:focus:ring-opacity-50">
        ...
        <div class="p-6 bg-card bg-opacity-50 dark:bg-card-dark dark:bg-opacity-50 rounded-xl shadow-md transition-all duration-300">
          <h2 class="flex items-center text-2xl font-semibold text-foreground dark:text-foreground-dark mb-4">
            <span class="flex items-center justify-center w-8 h-8 mr-4 bg-primary bg-opacity-20 text-primary dark:bg-primary-dark dark:bg-opacity-20 dark:text-primary-dark rounded-full text-lg">2</span>
            Select Standards File
          </h2>
          <button onclick={selectStandardsFile} class="w-full flex items-center justify-center bg-primary bg-opacity-10 hover:bg-primary hover:bg-opacity-20 dark:bg-primary-dark dark:bg-opacity-10 dark:hover:bg-primary-dark dark:hover:bg-opacity-20 text-primary dark:text-primary-dark font-bold py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 dark:focus:ring-primary-dark dark:focus:ring-opacity-50">
            <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
        ...
        <div class="p-6 bg-card bg-opacity-50 dark:bg-card-dark dark:bg-opacity-50 rounded-xl shadow-md transition-all duration-300">
          <h2 class="flex items-center text-2xl font-semibold text-foreground dark:text-foreground-dark mb-4">
            <span class="flex items-center justify-center w-8 h-8 mr-4 bg-primary bg-opacity-20 text-primary dark:bg-primary-dark dark:bg-opacity-20 dark:text-primary-dark rounded-full text-lg">3</span>
            Select Example File (Optional)
          </h2>
          <button onclick={selectExampleFile} class="w-full flex items-center justify-center bg-primary bg-opacity-10 hover:bg-primary hover:bg-opacity-20 dark:bg-primary-dark dark:bg-opacity-10 dark:hover:bg-primary-dark dark:hover:bg-opacity-20 text-primary dark:text-primary-dark font-bold py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 dark:focus:ring-primary-dark dark:focus:ring-opacity-50">
        ...
        <div class="p-6 bg-card bg-opacity-50 dark:bg-card-dark dark:bg-opacity-50 rounded-xl shadow-md transition-all duration-300">
          <h2 class="flex items-center text-2xl font-semibold text-foreground dark:text-foreground-dark mb-4">
            <span class="flex items-center justify-center w-8 h-8 mr-4 bg-primary bg-opacity-20 text-primary dark:bg-primary-dark dark:bg-opacity-20 dark:text-primary-dark rounded-full text-lg">4</span>
            Configure LLM
          </h2>
          <div class="space-y-4">
            <div>
            ...
            {#if llmProvider !== 'local'}
              <div>
                ...
                <input id="api-key" type="password" bind:value={apiKey} placeholder="Enter your API key" class="shadow-sm appearance-none border border-gray-300 dark:border-gray-600 rounded-lg w-full py-3 px-4 text-foreground dark:text-foreground-dark bg-background dark:bg-background-dark leading-tight focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 dark:focus:ring-primary-dark dark:focus:ring-opacity-50 focus:border-transparent transition-all duration-300" />
              </div>
              <div>
                <label class="block text-muted dark:text-muted-dark text-sm font-bold mb-2" for="model">Model Name</label>
                <input id="model" type="text" bind:value={model} placeholder="e.g., gpt-4, claude-2" class="shadow-sm appearance-none border border-gray-300 dark:border-gray-600 rounded-lg w-full py-3 px-4 text-foreground dark:text-foreground-dark bg-background dark:bg-background-dark leading-tight focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 dark:focus:ring-primary-dark dark:focus:ring-opacity-50 focus:border-transparent transition-all duration-300" />
              </div>
            {:else}
              <div>
        ...
        <!-- Action Buttons -->
        <div class="p-6 bg-card bg-opacity-50 dark:bg-card-dark dark:bg-opacity-50 rounded-xl shadow-md transition-all duration-300 space-y-4">
           <div class="flex space-x-4">
            <button onclick={saveConfig} class="flex-1 flex items-center justify-center bg-gray-600 bg-opacity-20 hover:bg-gray-600 hover:bg-opacity-40 text-foreground dark:text-foreground-dark font-bold py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50">
            ...
            <button onclick={loadConfig} class="flex-1 flex items-center justify-center bg-gray-600 bg-opacity-20 hover:bg-gray-600 hover:bg-opacity-40 text-foreground dark:text-foreground-dark font-bold py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50">
            ...
            <button onclick={clearAll} class="flex-1 flex items-center justify-center bg-red-600 bg-opacity-20 hover:bg-red-600 hover:bg-opacity-40 text-red-600 dark:text-red-500 font-bold py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50">
      ...
      <div class="p-6 bg-card bg-opacity-50 dark:bg-card-dark dark:bg-opacity-50 rounded-xl shadow-md flex flex-col transition-all duration-300">
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-2xl font-semibold text-foreground dark:text-foreground-dark">Evaluation Results</h2>
          <button onclick={copyToClipboard} class="flex items-center justify-center bg-gray-600 bg-opacity-20 hover:bg-gray-600 hover:bg-opacity-40 text-foreground dark:text-foreground-dark font-bold py-2 px-4 rounded-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 w-28">
            {#if copied}
        ...
        <div class="flex-grow bg-background dark:bg-background-dark p-4 rounded-lg border border-gray-200 border-opacity-50 dark:border-gray-700 dark:border-opacity-50 overflow-auto h-[calc(100vh-200px)] transition-colors duration-300 text-foreground dark:text-foreground-dark">
          {#if evaluationError}
            <div class="flex items-center p-4 bg-red-500 bg-opacity-10 text-red-500 rounded-lg">
...
<style lang="postcss">
  .diff-added {
    @apply bg-green-500/10 text-green-700 dark:text-green-400 rounded-md px-4 py-2 flex items-center;
  }
  .diff-added::before {
    content: '+';
    @apply mr-3 font-bold text-lg;
  }
  .diff-removed {
    @apply bg-red-500/10 text-red-700 dark:text-red-400 rounded-md px-4 py-2 flex items-center;
  }
  .diff-removed::before {
    content: '-';
    @apply mr-3 font-bold text-lg;
  ...
  .diff-comment {
    @apply bg-yellow-500/10 text-yellow-700 dark:text-yellow-400 rounded-md px-4 py-2 flex items-center;
  }
  .diff-comment::before {
    content: '!';
    @apply mr-3 font-bold text-lg;
